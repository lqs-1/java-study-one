...
public class MessageConstant {
    ...
    public static final String DELETE_CHECKITEM_FAIL_GROUP = "删除检查项失败,存在检查组";
    ...
    public static final String SEND_VALIDATECODE_FREQUENTLY = "发送过于频繁";
